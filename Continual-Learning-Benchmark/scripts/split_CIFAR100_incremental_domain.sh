...
python -u ../iBatchLearn.py --dataset CIFAR100 --train_aug --repeat $REPEAT --optimizer Adam    --force_out_dim 20 --first_split_size 20 --other_split_size 20 --schedule 80 120 160 --batch_size 128 --model_name WideResNet_28_2_cifar --model_type resnet --agent_type customization --agent_name NASH_5600    --lr 0.001 --reg_coef 0.001  | tee ${OUTDIR}/NASH.log
