...
from .exp_replay import Naive_Rehearsal, GEM, NASH, DPMCL
...
def NASH_16k(agent_config):
    agent = NASH(agent_config)
    agent.memory_size = 16000
    return agent


def DPMCL_16k(agent_config):
    agent = DPMCL(agent_config)
    agent.memory_size = 16000
    return agent


def DPMCL_5600(agent_config):
    agent = DPMCL(agent_config)
    agent.memory_size = 5600
    return agent


def NASH_5600(agent_config):
    agent = NASH(agent_config)
    agent.memory_size = 5600
    return agent